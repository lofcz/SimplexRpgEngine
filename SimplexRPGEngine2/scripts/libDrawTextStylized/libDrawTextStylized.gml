/// @function libDrawTextStylized(x, y, text, alpha, centered, roundedCorners, font)
...
var tmp_text, tmp_x, tmp_y, tmp_textClean, tmp_alpha, tmp_center, tmp_xo, tmp_yo, tmp_xo2, tmp_yo2, tmp_rc, tmp_font, tmp_array;
tmp_text = "";
tmp_x = x;
tmp_y = y;
tmp_alpha = 1;
