...
draw_sprite(equiped_image[4,0],equiped_image[4,1],xx+equ_axis_left_plate_x,yy+equ_axis_left_plate_y)
...
draw_sprite(equiped_image[3,0],equiped_image[3,1],xx+equ_axis_right_plate_x,yy+equ_axis_right_plate_y)
...
draw_sprite(equiped_image[2,0],equiped_image[2,1],xx+equ_axis_body_x,yy+equ_axis_body_y)
...
draw_sprite(equiped_image[5,0],equiped_image[5,1],xx+equ_axis_left_hand_x,yy+equ_axis_left_hand_y)
...
draw_sprite(equiped_image[6,0],equiped_image[6,1],xx+equ_axis_left_ring1_x-8,yy+equ_axis_left_ring1_y-8)
...
draw_sprite(equiped_image[7,0],equiped_image[7,1],xx+equ_axis_left_ring2_x-8,yy+equ_axis_left_ring2_y-8)
...
draw_sprite(equiped_image[8,0],equiped_image[8,1],xx+equ_axis_right_ring1_x-8,yy+equ_axis_right_ring1_y-8)
...
draw_sprite(equiped_image[9,0],equiped_image[9,1],xx+equ_axis_right_ring2_x-8,yy+equ_axis_right_ring2_y-8)
...
draw_sprite(equiped_image[10,0],equiped_image[10,1],xx+equ_axis_crown_x,yy+equ_axis_crown_y)
...
draw_sprite(equiped_image[11,0],equiped_image[11,1],xx+equ_axis_trophy1_x,yy+equ_axis_trophy1_y)
...
draw_sprite(equiped_image[12,0],equiped_image[12,1],xx+equ_axis_trophy2_x,yy+equ_axis_trophy2_y)
...
draw_sprite(equiped_image[13,0],equiped_image[13,1],xx+equ_axis_trophy3_x,yy+equ_axis_trophy3_y)
...
draw_sprite(equiped_image[14,0],equiped_image[14,1],xx+equ_axis_special1_x,yy+equ_axis_special1_y)
...
draw_sprite(equiped_image[15,0],equiped_image[15,1],xx+equ_axis_special2_x,yy+equ_axis_special2_y)
...
draw_sprite(equiped_image[16,0],equiped_image[16,1],xx+equ_axis_belt_x,yy+equ_axis_belt_y)
...
draw_sprite(equiped_image[17,0],equiped_image[17,1],xx+equ_axis_left_boot_x,yy+equ_axis_left_boot_y)
...
draw_sprite(equiped_image[18,0],equiped_image[18,1],xx+equ_axis_right_boot_x,yy+equ_axis_right_boot_y)
