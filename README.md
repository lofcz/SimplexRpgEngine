...
* **New features in the Simplex 2:**
  * Everything has been rewritten, mainly for the reliability and security purposes
  * Complete documentation
  * Much cleaner code, engine is even easier to use now
  * Integration with GMS2 new features - cameras system, JSDOC, multiple resource trees, etc.
  * Using Direct11 instead of Direct9
  * About 30% fps increse
